          ...
          <div className="justify-center flex-1 max-w-6xl px-4 py-4 mx-auto lg:py-0">
            ...
            <div className="flex flex-wrap py-10 -mx-3">
              <div className="w-full px-4 mb-11 md:w-1/2 lg:w-4/12 lg:mb-0">
                <a
                  href="#"
                  className="inline-block mb-4 text-xl font-bold text-gray-200  "
                >
                  About Company
                </a>
                ...
                <div className="flex justify-start mt-4 ">
                  ...
                  >
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      className="w-4 h-full mx-auto text-gray-300  bi bi-facebook"
                      viewBox="0 0 16 16"
                    >
                  ...
                  <a
                    href="#"
                    type="button"
                    className="m-1 leading-normal text-gray-300 uppercase transition duration-150 ease-in-out border-2 border-gray-300 rounded-full      hover:border-blue-500 hover:bg-blue-500 w-9 h-9"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                      fill="currentColor"
                      className="w-4 h-full mx-auto text-gray-300  bi bi-twitter"
                      viewBox="0 0 16 16"
                    >
                  ...
                  <a
                    href="#"
                    type="button"
                    className="m-1 leading-normal text-gray-300 uppercase transition duration-150 ease-in-out border-2 border-gray-300 rounded-full      hover:border-red-700 text-text-gray-50 hover:bg-red-700 w-9 h-9"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                      fill="currentColor"
                      className="w-4 h-full mx-auto text-gray-100  bi bi-google"
                      viewBox="0 0 16 16"
                    >
                  ...
                  <a
                    href="#"
                    type="button"
                    className="m-1 leading-normal text-gray-400 uppercase transition duration-150 ease-in-out border-2 border-gray-300 rounded-full      hover:border-blue-600 hover:bg-blue-600 w-9 h-9"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="16"
                      height="16"
                      fill="currentColor"
                      className="w-4 h-full mx-auto text-gray-300  bi bi-linkedin"
                      viewBox="0 0 16 16"
                    >
              ...
              <div className="w-full px-4 mb-2 lg:mb-0 md:w-1/3 lg:w-4/12">
                ...
                <p className="flex items-center mb-4">
                  ...
                  <span className="text-gray-300  ">+977-9836736352</span>
                </p>
              </div>
            </div>
          </div>
